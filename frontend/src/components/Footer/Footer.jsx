...
export default function () {
  const information = ['Акції', 'Кредит', 'Оплата і доставка', 'Гарантія', 'Часті запитання', 'Новини', 'Блог', 'Про нас', 'Політика конфіденційності', 'Контакти'];
  const services = ['Сервісний центр v-comp', 'Магазин Б/У товарів', 'Скупка Б/У', 'Ремонт ПК і оргтехніки', "Комп'ютерна допомога", 'Співробітництво', 'Головна'];
      ...
      <div className="footer__container">
        <div className={styles.footer__body}>
          <div className={styles.block}>
            <h6 className={styles.block__title}>Інформація</h6>
          ...
          <div className={styles.block}>
            <h6 className={styles.block__title}>Послуги та сервіси</h6>
            <ul className={styles.block__list}>
              {services?.map(item => {
                return <li key={item} className={styles.block__item}><a href="">{item}</a></li>;
              })}
          ...
          <div className={styles.block}>
            <h6 className={styles.block__title}>Контакти</h6>
            <div className={styles.block__list}>
              <ul className={styles.block}>
                <li className={styles.block__item}>(067) 11-12-485 - Отдел продаж</li>
                <li className={styles.block__item}>(066) 484-39-22 - Отдел продаж</li>
              ...
              <div className={`${styles.block__item} ${styles.location}`}>
                Дніпро<br />
                Європейська, 8 (минула Миронова 8)
              </div>
          ...
          <div className={styles.block}>
            <h6 className={styles.block__title}>Слідкуйте за нами</h6>
            ...
            <div className={styles.subscription}>
              <div className={styles.subscription__title}>Підписуйтесь на знижки</div>
          ...
          <div className={styles.licenses}>
            ...
            <div className={styles.licenses__text}>
