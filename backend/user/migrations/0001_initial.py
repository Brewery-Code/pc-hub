    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='avatars/default.png', null=True, upload_to=user.models.user_directory_path, validators=[user.models.validate_image], verbose_name='Фото профілю')),
